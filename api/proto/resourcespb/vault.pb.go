...
func (x *VaultGcpOverride) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VaultGcpOverride) ProtoMessage() {}

func (x *VaultGcpOverride) ProtoReflect() protoreflect.Message {
	mi := &file_api_proto_resourcespb_vault_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use VaultGcpOverride.ProtoReflect.Descriptor instead.
func (*VaultGcpOverride) Descriptor() ([]byte, []int) {
	return file_api_proto_resourcespb_vault_proto_rawDescGZIP(), []int{4}
}

func (x *VaultGcpOverride) GetProject() string {
	if x != nil {
		return x.Project
	}
	return ""
...
type VaultArgs struct {
	...
	GcpOverride      *VaultGcpOverride            `protobuf:"bytes,3,opt,name=gcp_override,json=gcpOverride,proto3" json:"gcp_override,omitempty"`
}
...
func (x *VaultArgs) GetGcpOverride() *VaultGcpOverride {
	if x != nil {
...
func (x *VaultAzureOutputs) Reset() {
	*x = VaultAzureOutputs{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_proto_resourcespb_vault_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *VaultAzureOutputs) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VaultAzureOutputs) ProtoMessage() {}

func (x *VaultAzureOutputs) ProtoReflect() protoreflect.Message {
	mi := &file_api_proto_resourcespb_vault_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use VaultAzureOutputs.ProtoReflect.Descriptor instead.
func (*VaultAzureOutputs) Descriptor() ([]byte, []int) {
	return file_api_proto_resourcespb_vault_proto_rawDescGZIP(), []int{6}
}

func (x *VaultAzureOutputs) GetKeyVaultId() string {
	if x != nil {
		return x.KeyVaultId
	}
	return ""
...
type VaultResource struct {
	...
	Name             string                             `protobuf:"bytes,2,opt,name=name,proto3" json:"name,omitempty"`
	GcpOverride      *VaultGcpOverride                  `protobuf:"bytes,3,opt,name=gcp_override,json=gcpOverride,proto3" json:"gcp_override,omitempty"`
	AzureOutputs     *VaultAzureOutputs                 `protobuf:"bytes,4,opt,name=azure_outputs,json=azureOutputs,proto3" json:"azure_outputs,omitempty"`
}

func (x *VaultResource) Reset() {
	*x = VaultResource{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_proto_resourcespb_vault_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*VaultResource) Descriptor() ([]byte, []int) {
	return file_api_proto_resourcespb_vault_proto_rawDescGZIP(), []int{7}
}
...
func (x *VaultResource) GetGcpOverride() *VaultGcpOverride {
	if x != nil {
		return x.GcpOverride
	}
	return nil
...
func (x *VaultResource) GetAzureOutputs() *VaultAzureOutputs {
	if x != nil {
...
var file_api_proto_resourcespb_vault_proto_rawDesc = []byte{
	...
	0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x49, 0x64, 0x22, 0x2c, 0x0a, 0x10, 0x56, 0x61,
	0x75, 0x6c, 0x74, 0x47, 0x63, 0x70, 0x4f, 0x76, 0x65, 0x72, 0x72, 0x69, 0x64, 0x65, 0x12, 0x18,
	0x0a, 0x07, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x07, 0x70, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x22, 0xbc, 0x01, 0x0a, 0x09, 0x56, 0x61, 0x75,
	0x6c, 0x74, 0x41, 0x72, 0x67, 0x73, 0x12, 0x51, 0x0a, 0x11, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e,
	...
	,
	...
	0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2e, 0x56, 0x61, 0x75, 0x6c, 0x74, 0x47,
	0x63, 0x70, 0x4f, 0x76, 0x65, 0x72, 0x72, 0x69, 0x64, 0x65, 0x52, 0x0b, 0x67, 0x63, 0x70, 0x4f,
	0x76, 0x65, 0x72, 0x72, 0x69, 0x64, 0x65, 0x12, 0x4b, 0x0a, 0x0d, 0x61, 0x7a, 0x75, 0x72, 0x65,
	0x5f, 0x6f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x26,
	0x2e, 0x64, 0x65, 0x76, 0x2e, 0x6d, 0x75, 0x6c, 0x74, 0x79, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75,
	0x72, 0x63, 0x65, 0x73, 0x2e, 0x56, 0x61, 0x75, 0x6c, 0x74, 0x41, 0x7a, 0x75, 0x72, 0x65, 0x4f,
...
var file_api_proto_resourcespb_vault_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_api_proto_resourcespb_vault_proto_goTypes = []interface{}{
	...
	(*VaultGcpOverride)(nil),                  // 4: dev.multy.resources.VaultGcpOverride
	(*VaultArgs)(nil),                         // 5: dev.multy.resources.VaultArgs
	(*VaultAzureOutputs)(nil),                 // 6: dev.multy.resources.VaultAzureOutputs
	(*VaultResource)(nil),                     // 7: dev.multy.resources.VaultResource
...
var file_api_proto_resourcespb_vault_proto_depIdxs = []int32{
	5, // 0: dev.multy.resources.CreateVaultRequest.resource:type_name -> dev.multy.resources.VaultArgs
	5, // 1: dev.multy.resources.UpdateVaultRequest.resource:type_name -> dev.multy.resources.VaultArgs
	8, // 2: dev.multy.resources.VaultArgs.common_parameters:type_name -> dev.multy.common.ResourceCommonArgs
	4, // 3: dev.multy.resources.VaultArgs.gcp_override:type_name -> dev.multy.resources.VaultGcpOverride
	9, // 4: dev.multy.resources.VaultResource.common_parameters:type_name -> dev.multy.common.CommonResourceParameters
	4, // 5: dev.multy.resources.VaultResource.gcp_override:type_name -> dev.multy.resources.VaultGcpOverride
	6, // 6: dev.multy.resources.VaultResource.azure_outputs:type_name -> dev.multy.resources.VaultAzureOutputs
...
func file_api_proto_resourcespb_vault_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_api_proto_resourcespb_vault_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*VaultAzureOutputs); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_proto_resourcespb_vault_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
