...
type VaultAccessPolicyAwsOutputs struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	IamPolicyArn string `protobuf:"bytes,1,opt,name=iam_policy_arn,json=iamPolicyArn,proto3" json:"iam_policy_arn,omitempty"`
}

func (x *VaultAccessPolicyAwsOutputs) Reset() {
	*x = VaultAccessPolicyAwsOutputs{}
	if protoimpl.UnsafeEnabled {
...
func (x *VaultAccessPolicyAwsOutputs) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VaultAccessPolicyAwsOutputs) ProtoMessage() {}

func (x *VaultAccessPolicyAwsOutputs) ProtoReflect() protoreflect.Message {
	mi := &file_api_proto_resourcespb_vault_access_policy_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use VaultAccessPolicyAwsOutputs.ProtoReflect.Descriptor instead.
func (*VaultAccessPolicyAwsOutputs) Descriptor() ([]byte, []int) {
	return file_api_proto_resourcespb_vault_access_policy_proto_rawDescGZIP(), []int{6}
}

func (x *VaultAccessPolicyAwsOutputs) GetIamPolicyArn() string {
	if x != nil {
		return x.IamPolicyArn
	}
	return ""
}

type VaultAccessPolicyAzureOutputs struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	KeyVaultAccessPolicyId string `protobuf:"bytes,1,opt,name=key_vault_access_policy_id,json=keyVaultAccessPolicyId,proto3" json:"key_vault_access_policy_id,omitempty"`
}

func (x *VaultAccessPolicyAzureOutputs) Reset() {
	*x = VaultAccessPolicyAzureOutputs{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_proto_resourcespb_vault_access_policy_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *VaultAccessPolicyAzureOutputs) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VaultAccessPolicyAzureOutputs) ProtoMessage() {}

func (x *VaultAccessPolicyAzureOutputs) ProtoReflect() protoreflect.Message {
	mi := &file_api_proto_resourcespb_vault_access_policy_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use VaultAccessPolicyAzureOutputs.ProtoReflect.Descriptor instead.
func (*VaultAccessPolicyAzureOutputs) Descriptor() ([]byte, []int) {
	return file_api_proto_resourcespb_vault_access_policy_proto_rawDescGZIP(), []int{7}
}

func (x *VaultAccessPolicyAzureOutputs) GetKeyVaultAccessPolicyId() string {
	if x != nil {
		return x.KeyVaultAccessPolicyId
	}
	return ""
}

type VaultAccessPolicyGcpOutputs struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	SecretManagerSecretIamMembershipId []string `protobuf:"bytes,1,rep,name=secret_manager_secret_iam_membership_id,json=secretManagerSecretIamMembershipId,proto3" json:"secret_manager_secret_iam_membership_id,omitempty"`
}

func (x *VaultAccessPolicyGcpOutputs) Reset() {
	*x = VaultAccessPolicyGcpOutputs{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_proto_resourcespb_vault_access_policy_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *VaultAccessPolicyGcpOutputs) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VaultAccessPolicyGcpOutputs) ProtoMessage() {}

func (x *VaultAccessPolicyGcpOutputs) ProtoReflect() protoreflect.Message {
	mi := &file_api_proto_resourcespb_vault_access_policy_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use VaultAccessPolicyGcpOutputs.ProtoReflect.Descriptor instead.
func (*VaultAccessPolicyGcpOutputs) Descriptor() ([]byte, []int) {
	return file_api_proto_resourcespb_vault_access_policy_proto_rawDescGZIP(), []int{8}
}

func (x *VaultAccessPolicyGcpOutputs) GetSecretManagerSecretIamMembershipId() []string {
	if x != nil {
		return x.SecretManagerSecretIamMembershipId
	}
	return nil
}
...
type VaultAccessPolicyResource struct {
	...
	Identity         string                                  `protobuf:"bytes,3,opt,name=identity,proto3" json:"identity,omitempty"`
	Access           VaultAccess_Enum                        `protobuf:"varint,4,opt,name=access,proto3,enum=dev.multy.resources.VaultAccess_Enum" json:"access,omitempty"`
	AwsOutputs       *VaultAccessPolicyAwsOutputs            `protobuf:"bytes,5,opt,name=aws_outputs,json=awsOutputs,proto3" json:"aws_outputs,omitempty"`
	AzureOutputs     *VaultAccessPolicyAzureOutputs          `protobuf:"bytes,6,opt,name=azure_outputs,json=azureOutputs,proto3" json:"azure_outputs,omitempty"`
	GcpOutputs       *VaultAccessPolicyGcpOutputs            `protobuf:"bytes,7,opt,name=gcp_outputs,json=gcpOutputs,proto3" json:"gcp_outputs,omitempty"`
}

func (x *VaultAccessPolicyResource) Reset() {
	*x = VaultAccessPolicyResource{}
	if protoimpl.UnsafeEnabled {
		mi := &file_api_proto_resourcespb_vault_access_policy_proto_msgTypes[9]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*VaultAccessPolicyResource) Descriptor() ([]byte, []int) {
	return file_api_proto_resourcespb_vault_access_policy_proto_rawDescGZIP(), []int{9}
}
...
func (x *VaultAccessPolicyResource) GetAwsOutputs() *VaultAccessPolicyAwsOutputs {
	if x != nil {
		return x.AwsOutputs
	}
	return nil
...
func (x *VaultAccessPolicyResource) GetAzureOutputs() *VaultAccessPolicyAzureOutputs {
	if x != nil {
...
func (x *VaultAccessPolicyResource) GetGcpOutputs() *VaultAccessPolicyGcpOutputs {
	if x != nil {
		return x.GcpOutputs
	}
	return nil
...
var file_api_proto_resourcespb_vault_access_policy_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	0x63, 0x79, 0x41, 0x77, 0x73, 0x4f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x73, 0x52, 0x0a, 0x61, 0x77,
	0x73, 0x4f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x73, 0x12, 0x57, 0x0a, 0x0d, 0x61, 0x7a, 0x75, 0x72,
	0x65, 0x5f, 0x6f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x73, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32,
	...
	0x73, 0x12, 0x51, 0x0a, 0x0b, 0x67, 0x63, 0x70, 0x5f, 0x6f, 0x75, 0x74, 0x70, 0x75, 0x74, 0x73,
	0x18, 0x07, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x30, 0x2e, 0x64, 0x65, 0x76, 0x2e, 0x6d, 0x75, 0x6c,
	0x74, 0x79, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2e, 0x56, 0x61, 0x75,
	0x6c, 0x74, 0x41, 0x63, 0x63, 0x65, 0x73, 0x73, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x47, 0x63,
...
var file_api_proto_resourcespb_vault_access_policy_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_api_proto_resourcespb_vault_access_policy_proto_goTypes = []interface{}{
	...
	(*VaultAccessPolicyAwsOutputs)(nil),            // 7: dev.multy.resources.VaultAccessPolicyAwsOutputs
	(*VaultAccessPolicyAzureOutputs)(nil),          // 8: dev.multy.resources.VaultAccessPolicyAzureOutputs
	(*VaultAccessPolicyGcpOutputs)(nil),            // 9: dev.multy.resources.VaultAccessPolicyGcpOutputs
	(*VaultAccessPolicyResource)(nil),              // 10: dev.multy.resources.VaultAccessPolicyResource
...
var file_api_proto_resourcespb_vault_access_policy_proto_depIdxs = []int32{
	...
	11, // 2: dev.multy.resources.VaultAccessPolicyArgs.common_parameters:type_name -> dev.multy.common.ChildResourceCommonArgs
	0,  // 3: dev.multy.resources.VaultAccessPolicyArgs.access:type_name -> dev.multy.resources.VaultAccess.Enum
	12, // 4: dev.multy.resources.VaultAccessPolicyResource.common_parameters:type_name -> dev.multy.common.CommonChildResourceParameters
	0,  // 5: dev.multy.resources.VaultAccessPolicyResource.access:type_name -> dev.multy.resources.VaultAccess.Enum
	7,  // 6: dev.multy.resources.VaultAccessPolicyResource.aws_outputs:type_name -> dev.multy.resources.VaultAccessPolicyAwsOutputs
	8,  // 7: dev.multy.resources.VaultAccessPolicyResource.azure_outputs:type_name -> dev.multy.resources.VaultAccessPolicyAzureOutputs
	9,  // 8: dev.multy.resources.VaultAccessPolicyResource.gcp_outputs:type_name -> dev.multy.resources.VaultAccessPolicyGcpOutputs
...
func file_api_proto_resourcespb_vault_access_policy_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_api_proto_resourcespb_vault_access_policy_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*VaultAccessPolicyAwsOutputs); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_proto_resourcespb_vault_access_policy_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*VaultAccessPolicyAzureOutputs); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_proto_resourcespb_vault_access_policy_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*VaultAccessPolicyGcpOutputs); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_api_proto_resourcespb_vault_access_policy_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
